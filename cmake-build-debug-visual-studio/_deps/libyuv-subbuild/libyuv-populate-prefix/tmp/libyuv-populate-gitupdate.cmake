...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "stable"
  WORKING_DIRECTORY "C:/Dev/RTC-stack-poc/cmake-build-debug-visual-studio/_deps/libyuv-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Dev/RTC-stack-poc/cmake-build-debug-visual-studio/_deps/libyuv-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Dev/RTC-stack-poc/cmake-build-debug-visual-studio/_deps/libyuv-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
